  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        Component: lazy(() => import('@/views/admin/layouts/sidebar-dark')),
      },
      {
      ...
      },
      {
        ...
        Component: lazy(() => import('@/views/admin/layouts/topbar-light')),
      },
      {
        path: '/maps/leaflet',
      ...
      },
      {
        ...
        Component: lazy(() => import('@/views/admin/plugins/sortable')),
      },
      {
      ...
      {
        path: '/widgets',
        Component: lazy(() => import('@/views/admin/widgets')),
      },
    ],
  },
  {

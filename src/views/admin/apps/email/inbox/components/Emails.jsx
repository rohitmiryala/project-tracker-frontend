...
const EmailList = ({ toggleSidebar }) => {
  const [search, setSearch] = useState('')
  const filteredEmails = emailData.filter((e) => e.user.name.toLowerCase().includes(search.toLowerCase()) || e.subject.toLowerCase().includes(search.toLowerCase()) || e.snippet.toLowerCase().includes(search.toLowerCase()))
